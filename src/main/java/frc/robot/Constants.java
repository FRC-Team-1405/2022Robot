...
public final class Constants {
    ...
    public final static class FieldPosition {
        ...
        public static Pose2d Tarmac_RightReverse    = GenerateTrajectory.pose2dToOrigin( Units.inchesToMeters(-68), Units.inchesToMeters(-58), true );
        public static Pose2d Tarmac_FarRightReverse = GenerateTrajectory.pose2dToOrigin( Units.inchesToMeters(-20), Units.inchesToMeters(-91), true );
